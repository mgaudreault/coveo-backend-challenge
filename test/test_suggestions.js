...
describe('Suggestion methods', function() {
  describe('getSuggestions()', function() {
    ...
    it('should return London, US, OH if we search for london with OH admin1_code facet', function(done) {
      getSuggestions('London', undefined, undefined, [{admin1_code: 'OH'}], function(err, suggestions) {
        if (err) {
          done(err);
        } else {
